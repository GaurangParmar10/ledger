    ...
    <div className="space-y-4 pb-bottom-nav font-sans text-neutral-900 dark:text-neutral-100">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-xs font-bold focus:outline-none"
        />
        {searchQuery && (
      ...
      {searchQuery && (
        <div className="p-2 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-900 space-y-1 max-h-40 overflow-y-auto">
      ...
      <div className="grid grid-cols-7 gap-1">
        {calendarGrid.map((item, idx) => {
          if (!item) {
            return <div key={`blank_${idx}`} className="h-11" />;
          }
      ...
      <div className="mono-card rounded-xl p-3.5 space-y-2">
        ...
        {!activeRecord.hasActivity && !activeRecord.noteObj?.notes ? (
          <p className="text-xs font-bold text-neutral-400 py-3 italic text-center">
            No study recorded.
          </p>
        ) : (
          <div className="space-y-2.5 text-xs">
            ...
            {activeRecord.totalMins > 0 && (
              <div className="p-2 rounded bg-neutral-100 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 space-y-0.5 text-xs">
